"""
H8.E — Test runtime success implícito (sin errores = success)
"""
import json
...
def test_login_flow_completes_without_error_marks_success(monkeypatch, tmp_path: Path):
    """
    Offline (sin Playwright):
    - Flow determinista completa todas las acciones sin errores
    - Verificar que status final es "success" (no failed)
    """
